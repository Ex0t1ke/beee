...
/**
 * Highly Optimized Farm Pen Background (Step 5)
 * - Removed all Framer Motion motion.div instances
 * - Pure CSS GPU-accelerated keyframe transforms (will-change: transform)
 * - Zero JS thread blocking or re-render overhead on mobile
 */
export const FarmPenBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none select-none z-0">
      ...
      {/* Sun with pulsing warm rays (Pure CSS keyframe spin) */}
      <div className="absolute top-6 right-16 md:right-28">
        <div className="relative flex items-center justify-center animate-sun-spin">
      ...
      {/* Floating Animated Clouds (Pure CSS translates) */}
      <div className="absolute top-12 left-0 opacity-85 animate-cloud-1">
      ...
      <div className="absolute top-28 left-0 opacity-70 animate-cloud-2">
      ...
      <div className="absolute top-8 left-0 opacity-60 animate-cloud-3">
      ...
      {/* THE PADDOCK / CORRAL (ЗАГОН) - Wooden Fence Enclosure */}
      ...
      <div className="absolute bottom-4 inset-x-4 md:inset-x-12 flex justify-between items-end opacity-90">
        {[
          ...
          { color: '#fef08a', size: 20 },
          { color: '#ffffff', size: 18 },
          { color: '#f472b6', size: 16 },
          { color: '#ffffff', size: 20 },
          { color: '#fef08a', size: 18 },
          { color: '#ffffff', size: 16 },
          { color: '#f472b6', size: 18 },
        ].map((flower, idx) => (
      ...
      {/* Fluttering Butterflies (Pure CSS flight paths & wing flapping) */}
      <div className="absolute top-1/2 left-10 pointer-events-none animate-butterfly-left">
        <div className="flex gap-0.5">
          <div className="w-3.5 h-3 bg-gradient-to-br from-amber-400 to-orange-500 rounded-full animate-wing-left" />
          <div className="w-3.5 h-3 bg-gradient-to-bl from-amber-400 to-orange-500 rounded-full animate-wing-right" />
        </div>
      </div>

      <div className="absolute top-1/2 right-12 pointer-events-none animate-butterfly-right">
        <div className="flex gap-0.5">
          <div className="w-3 h-2.5 bg-gradient-to-br from-sky-400 to-indigo-500 rounded-full animate-wing-left-blue" />
          <div className="w-3 h-2.5 bg-gradient-to-bl from-sky-400 to-indigo-500 rounded-full animate-wing-right-blue" />
        </div>
      </div>
    </div>
  );
